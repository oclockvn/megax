...
namespace MegaApp.Core.Migrations
{
    ...
    [Migration("20231121143947_AddBirthdayReminder")]
    partial class AddBirthdayReminder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MegaApp.Core.Db.Entities.BirthdayReminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MegaApp.Core.Db.Entities.TeamMember", b =>
                {
            ...
            modelBuilder.Entity("MegaApp.Core.Db.Entities.TeamMember", b =>
                {
                    b.HasOne("MegaApp.Core.Db.Entities.User", "Member")
                        .WithMany("Teams")
